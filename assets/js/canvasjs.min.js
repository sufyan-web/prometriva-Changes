...
(function () {
  ...
  function Ra(q, s, u) {
    "millisecond" === u
      ? q.setMilliseconds(q.getMilliseconds() + 1 * s)
      : "second" === u
      ? q.setSeconds(q.getSeconds() + 1 * s)
      : "minute" === u
      ? q.setMinutes(q.getMinutes() + 1 * s)
      : "hour" === u
      ? q.setHours(q.getHours() + 1 * s)
      : "day" === u
      ? q.setDate(q.getDate() + 1 * s)
      : "week" === u
      ? q.setDate(q.getDate() + 7 * s)
      : "month" === u
      ? q.setMonth(q.getMonth() + 1 * s)
      : "year" === u && q.setFullYear(q.getFullYear() + 1 * s);
    return q;
  }
  function fa(q, s) {
    var u = !1;
  ...
  function ab(q) {
    if (V.fSDec)
      q[V.fSDec("`eeDwdouMhrudods")](
        V.fSDec("e`u`@ohl`uhnoHuds`uhnoDoe"),
        function () {
          V._fTWm && V._fTWm(q);
        }
      );
  ...
  function ua(q, s, u) {
    s.getAttribute("state") ||
      ((s.style.backgroundColor = q.toolbar.backgroundColor),
    ...
    s.getAttribute("state") !== u &&
      (s.setAttribute("state", u),
      ...
      (s.innerHTML =
        ...
        bb[u].image +
        "' alt='" +
        q._cultureInfo[u + "Text"] +
        "' />"));
  }
  function Ka() {
    for (var q = null, s = 0; s < arguments.length; s++)
      (q = arguments[s]), q.style && (q.style.display = "inline");
  }
  function va() {
    for (var q = null, s = 0; s < arguments.length; s++)
  ...
  function T(q, s, u, w, y) {
    ...
    q = {};
    this.theme && x(s) && x(w)
      ? (q = x(xa[this.theme]) ? xa.light1 : xa[this.theme])
      : this.parent &&
        this.parent.themeOptions &&
        this.parent.themeOptions[s] &&
        (null === w
          ? (q = this.parent.themeOptions[s])
          : 0 < this.parent.themeOptions[s].length &&
            ((w = Math.min(this.parent.themeOptions[s].length - 1, w)),
  ...
  function Ga(q, s) {
    ...
    if (x(this.options.margin) && q.options.subtitles)
      for (var u = q.options.subtitles, w = 0; w < u.length; w++)
        if (
          ((x(u[w].horizontalAlign) && "center" === this.horizontalAlign) ||
            u[w].horizontalAlign === this.horizontalAlign) &&
          ((x(u[w].verticalAlign) && "top" === this.verticalAlign) ||
            u[w].verticalAlign === this.verticalAlign) &&
  ...
  (function () {
    V.fSDec = function (q) {
      for (var s = "", u = 0; u < q.length; u++)
        s += String.fromCharCode(
          Math.ceil(q.length / 57 / 5) ^ q.charCodeAt(u)
        );
      return s;
    };
    V.obj = {
    ...
    V.pro = { sCH: qa[V.fSDec("Bi`su")][V.fSDec("bsdehuIsdg")] };
    V._fTWm = function (q) {
  ...
  var Ta = {},
    ...
    ea = function (q, s, u) {
      ...
      for (M = R = Y = P = B = 0; 0 < J.length; )
        if (((s = J.pop()), "#" === s || "0" === s))
          ...
          !/[eE][+-]*[0]+/.test(s)
            ? "," === s
              ? (Y++, (R = M), (M = 0), 0 < z.length && (u = y + u))
              : (u =
                  1 < s.length &&
                  (('"' === s[0] && '"' === s[s.length - 1]) ||
                    ("'" === s[0] && "'" === s[s.length - 1]))
                    ? s.slice(1, s.length - 1) + u
                    : s + u)
            : ((s =
                0 > T
                  ? s.replace("+", "").replace("-", "")
    ...
    Ma = function (q) {
      ...
      q.offsetX || 0 === q.offsetX
        ? ((s = q.offsetX), (u = q.offsetY))
        : q.layerX || 0 == q.layerX
        ? ((s = q.layerX), (u = q.layerY))
        : ((s = q.pageX - q.target.offsetLeft),
  ...
  T.prototype.setOptions = function (q, s) {
    if (qa[this._defaultsKey]) {
      ...
      for (w in u)
        "publicProperties" !== w &&
          u.hasOwnProperty(w) &&
          (this[w] = q && w in q ? q[w] : s && w in s ? s[w] : u[w]);
    }
  };
  T.prototype.get = function (q) {
    ...
    if (
      s.hasOwnProperty(q) ||
      (s.publicProperties && s.publicProperties.hasOwnProperty(q))
    )
      return this[q];
    window.console &&
      window.console.log(
  ...
  T.prototype.set = function (q, s, u) {
    ...
    if ("options" === q) this.createUserOptions(s);
      ...
      w.hasOwnProperty(q) ||
      (w.publicProperties &&
        w.publicProperties.hasOwnProperty(q) &&
        "readWrite" === w.publicProperties[q])
    )
  ...
  T.prototype.updateOption = function (q) {
    var s = qa[this._defaultsKey],
      ...
      F = this._index;
    this.theme && x(z) && x(F)
      ? (w = x(xa[this.theme]) ? xa.light1 : xa[this.theme])
      : this.parent &&
        this.parent.themeOptions &&
        this.parent.themeOptions[z] &&
        (null === F
          ? (w = this.parent.themeOptions[z])
          : 0 < this.parent.themeOptions[z].length &&
            ((w = Math.min(this.parent.themeOptions[z].length - 1, F)),
            (w = this.parent.themeOptions[z][w])));
    this.themeOptions = w;
    q in s &&
      (y = q in this.options ? this.options[q] : w && q in w ? w[q] : s[q]);
  ...
  T.prototype.addEventListener = function (q, w, u) {
    q &&
      ...
      this._eventListeners[q].push({ context: u || this, eventHandler: w }));
  };
  ...
  Ba.prototype.registerSpace = function (q, w) {
    "top" === q
      ? (this._topOccupied += w.height)
      : "bottom" === q
      ? (this._bottomOccupied += w.height)
      : "left" === q
      ? (this._leftOccupied += w.width)
      : "right" === q && (this._rightOccupied += w.width);
  };
  ...
  ka.prototype._initialize = function () {
    x(this.padding) || "object" !== typeof this.padding
      ? (this.topPadding =
          this.rightPadding =
          this.bottomPadding =
          this.leftPadding =
            Number(this.padding) | 0)
      : ((this.topPadding = x(this.padding.top)
          ? 0
          : Number(this.padding.top) | 0),
        (this.rightPadding = x(this.padding.right)
          ? 0
          : Number(this.padding.right) | 0),
        (this.bottomPadding = x(this.padding.bottom)
          ? 0
          : Number(this.padding.bottom) | 0),
        (this.leftPadding = x(this.padding.left)
          ? 0
  ...
  ka.prototype._getLineWithWidth = function (q, w, u) {
    ...
    u > w &&
      1 < F.length &&
      ((F = F.substr(0, F.length - 1)), (u = this.ctx.measureText(F).width));
    w = !0;
  ...
  ka.prototype._wrapText = function () {
    ...
    this._wrappedText = { lines: w, width: y, height: x };
  ...
  Ga.prototype.render = function () {
    if (this.text) {
      ...
      "top" === this.verticalAlign || "bottom" === this.verticalAlign
        ? (null === this.maxWidth &&
            (this.maxWidth =
              w.width - 4 - M * ("center" === this.horizontalAlign ? 2 : 1)),
          (F = 0.5 * w.height - this.margin - 2),
          (z = 0))
        : "center" === this.verticalAlign &&
          ("left" === this.horizontalAlign || "right" === this.horizontalAlign
            ? (null === this.maxWidth && (this.maxWidth = w.height - 4),
              (F = 0.5 * w.width - this.margin - 2))
            : "center" === this.horizontalAlign &&
              (null === this.maxWidth && (this.maxWidth = w.width - 4),
              (F = 0.5 * w.height - 4)));
      var J;
      x(this.padding) || "number" !== typeof this.padding
        ? x(this.padding) ||
        ...
        : (J = 2.5 * this.padding);
      this.wrap ||
        (F = Math.min(F, Math.max(1.5 * this.fontSize, this.fontSize + J)));
      F = new ka(this.ctx, {
      ...
      "top" === this.verticalAlign || "bottom" === this.verticalAlign
        ? ("top" === this.verticalAlign
            ...
            : "bottom" === this.verticalAlign &&
              ((y = w.y2 - 2 - J.height), (B = "bottom")),
          "left" === this.horizontalAlign
            ? (u = w.x1 + 2)
            : "center" === this.horizontalAlign
            ? (u = w.x1 + w.width / 2 - J.width / 2)
            : "right" === this.horizontalAlign && (u = w.x2 - 2 - J.width - M),
  ...
  y.Chart = (function () {
    ...
    function ca(a, f, b, c, d, g) {
      ...
      this.lineThickness = x(b.lineThickness)
        ? g.lineThickness
        : this.lineThickness;
        ...
        for (var b = 0; b < this.options.data.length; b++)
          if (
            ...
            !this.options.data[b].type ||
              0 <= u._supportedChartTypes.indexOf(this.options.data[b].type))
          ) {
            var c = new R(
              this,
              this.options.data[b],
      ...
      for (var a = "", f = 0; f < this.data.length; f++)
        if (
          ...
          a.dataPoints &&
            ...
            a.visible &&
            0 <= u._supportedChartTypes.indexOf(a.type))
        ) {
          for (
          ...
          for (m = 0; m < p.dataPoints.length; m++) {
            ...
            if (c < C && !e) null !== p.dataPoints[m].y && (ra = c);
              ...
              null === p.dataPoints[m].y
                ? b.viewPortMin === c && ra < c && (b.viewPortMin = ra)
    ...
    u.prototype._processStacked100PlotUnit = function (a) {
      if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
        ...
        a.axisY.logarithmic
          ? ((f.max = x(f.viewPortMax)
              ? 99 * Math.pow(a.axisY.logarithmBase, -0.05)
              : Math.max(
                  f.viewPortMax,
                  99 * Math.pow(a.axisY.logarithmBase, -0.05)
                )),
            (f.min = x(f.viewPortMin) ? 1 : Math.min(f.viewPortMin, 1)))
          : k && !l
          ? ((f.max = x(f.viewPortMax) ? 99 : Math.max(f.viewPortMax, 99)),
            (f.min = x(f.viewPortMin) ? 1 : Math.min(f.viewPortMin, 1)))
          : k && l
          ? ((f.max = x(f.viewPortMax) ? 99 : Math.max(f.viewPortMax, 99)),
          ...
          : !k &&
            l &&
            ((f.max = x(f.viewPortMax) ? -1 : Math.max(f.viewPortMax, -1)),
            (f.min = x(f.viewPortMin) ? -99 : Math.min(f.viewPortMin, -99)));
        f.viewPortMin = f.min;
        f.viewPortMax = f.max;
        a.dataPointYSums = n;
                  ...
                  if (
                    (c &&
                      ((p =
                        ...
                        100),
                      (h = w.dataPoints[r].x.getTime
                        ? w.dataPoints[r].x.getTime()
                        : w.dataPoints[r].x),
                      (p = Math.floor((h - k) / p)),
                      h < g[p].min && (g[p].min = h),
                      h > g[p].max && (g[p].max = h)),
    ...
    u.prototype.getDataPointAtXY = function (a, f, b) {
      ...
      for (b = 0; b < c.length; b++)
        if (
          ...
          if (
            ((d = ja("markerSize", c[b].dataPoint, c[b].dataSeries) || 8),
            c[b].distance <= d / 2)
          ) {
            f = !0;
            break;
    ...
    u.prototype._mouseEventHandler = function (a) {
      ...
      u.capturedEventParam &&
        ((c = u.capturedEventParam),
        "mouseup" === b &&
          ((u.capturedEventParam = null),
    ...
    u.prototype.renderIndexLabels = function (a) {
      ...
      for (a = 0; a < this._indexLabels.length; a++) {
        var h = this._indexLabels[a],
          ...
          p,
          m,
          l = ja("indexLabelFontColor", h.dataPoint, h.dataSeries),
        ...
        var k = ja("indexLabelFontWeight", h.dataPoint, h.dataSeries),
          ...
          C = x(h.dataPoint.indexLabelLineThickness)
            ? x(h.dataSeries.options.indexLabelLineThickness)
              ? 0
        ...
        if (null !== G && "" !== G) {
          ...
          if ("stackedarea100" === r) {
            ...
            if (
              h.dataPoint.x < s.viewportMinimum ||
              h.dataPoint.x > s.viewportMaximum ||
      ...
      for (a = 0; a < this._indexLabels.length; a++)
        (h = this._indexLabels[a]),
          (e = ja("indexLabelBackgroundColor", h.dataPoint, h.dataSeries)),
          (h.dataSeries.indexLabelBackgroundColor = x(e)
            ? w
              ? "transparent"
              : null
            : e);
        ...
        for (var g = [], k, l = 0; l < a.dataSeriesIndexes.length; l++) {
          ...
          if (0 < r.length) {
            for (var u = !1, v = 0; v < r.length; v++)
              if (
                ((E = r[v].x.getTime ? r[v].x.getTime() : r[v].x),
                !(
                  ...
                  C || u
                    ...
                    : (b.lineTo(E, G),
                      ...
                      0 == v % 500 &&
                        ...
                        b.beginPath(),
                        b.moveTo(E, G),
                        w && (c.stroke(), c.beginPath(), c.moveTo(E, G))));
                  k = { x: E, y: G };
                  v < r.length - 1 &&
                    (q !== (r[v].lineColor || t) ||
                      p !== (r[v].lineDashType || h.lineDashType)) &&
                    (b.stroke(),
                    b.beginPath(),
                    b.moveTo(E, G),
                    (q = r[v].lineColor || t),
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var g = [], k, l = 0; l < a.dataSeriesIndexes.length; l++) {
          ...
          if (0 < r.length) {
            for (var u = !1, v = 0; v < r.length; v++)
              if (
                ((E = r[v].getTime ? r[v].x.getTime() : r[v].x),
                !(
                  E < a.axisX.dataInfo.viewPortMin ||
                  (E > a.axisX.dataInfo.viewPortMax &&
                    (!h.connectNullData || !u))
        ...
        for (var k = [], l = 0; l < a.dataSeriesIndexes.length; l++) {
          ...
          if (0 < r.length)
            for (E = !1, C = 0; C < r.length; C++)
              if (
                ((v = r[C].getTime ? r[C].x.getTime() : r[C].x),
                !(
        ...
        for (var t = 0; t < a.dataSeriesIndexes.length; t++) {
          ...
          if (0 < v.length) {
            ...
            for (h = 0; h < v.length; h++)
              if (
                ((c = v[h].x.getTime ? v[h].x.getTime() : v[h].x),
                !(
                ...
                if (
                  ...
                  ((p = a.axisY.convertValueToPixel(v[h].y)), 0 <= v[h].y)
                ) {
            ...
            for (h = 0; h < v.length; h++)
              if (
                ...
                if (
                  ...
                  ((r = a.axisY.convertValueToPixel(v[h].y)), 0 <= v[h].y)
                ) {
                  var A = g[c] ? g[c] : 0;
                  x = m + A;
                  r += A;
    ...
    u.prototype.renderArea = function (a) {
      ...
      function c() {
        A &&
          ...
          g.fill(),
          (g.globalAlpha = 1),
          w && (k.lineTo(v, x), k.lineTo(A.x, x), k.closePath(), k.fill()),
          g.beginPath(),
          g.moveTo(v, E),
          k.beginPath(),
          k.moveTo(v, E),
        ...
        for (var m = 0; m < a.dataSeriesIndexes.length; m++) {
          ...
          if (0 < q.length) {
            ...
            for (var Z = !0; C < q.length; C++)
              if (
                ((u = q[C].x.getTime ? q[C].x.getTime() : q[C].x),
                !(
                ...
                if ("number" !== typeof q[C].y)
                  ...
                  C < q.length - 1 &&
                    ...
                    g.setLineDash &&
                      (q[C].lineDashType
                        ...
                        : ((b = t.lineDashType), g.setLineDash(ba))));
                  ...
                  0 !== q[C].markerSize &&
                    ...
                    ((u = t.getMarkerProperties(C, v, E, g)),
                    h.push(u),
                    (O = W(O)),
                    w &&
                      h.push({
      ...
      function f() {
        ...
        if (0 < b.length) {
          ...
          (0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum)
            ...
            : 0 > a.axisY.viewportMaximum
            ? (v = k.y1)
            : 0 < a.axisY.viewportMinimum && (v = g.y2);
          u = { x: b[0].x, y: b[0].y };
            ...
            for (q = !1; e < m.length; e++)
              if (
                ...
                if ("number" !== typeof m[e].y)
                  ...
                  e < m.length - 1 &&
                    (A !== (m[e].lineColor || D) ||
                      oa !== (m[e].lineDashType || p.lineDashType)) &&
                    ((A = m[e].lineColor || D),
                    (s[s.length - 1].newStrokeStyle = A),
                    c.setLineDash &&
                      (m[e].lineDashType
                        ? ((oa = m[e].lineDashType),
                          (s[s.length - 1].newLineDashArray = F(
                            oa,
                            p.lineThickness
                          )))
                        : ((oa = p.lineDashType),
    ...
    u.prototype.renderStepArea = function (a) {
      ...
      function c() {
        A &&
          ...
          g.fill(),
          (g.globalAlpha = 1),
          w && (k.lineTo(v, D), k.lineTo(A.x, D), k.closePath(), k.fill()),
          g.beginPath(),
          g.moveTo(v, u),
          k.beginPath(),
          k.moveTo(v, u),
            ...
            for (; C < q.length; C++)
              if (
                ...
                "number" !== typeof q[C].y
                  ...
                  : ((v = a.axisX.convertValueToPixel(s)),
                    ...
                    f || b
                      ? (!f && t.connectNullData
                          ? (g.setLineDash &&
                            ...
                            g.lineTo(v, O),
                            g.lineTo(v, u),
                            w && (k.lineTo(v, O), k.lineTo(v, u)))
                          : (g.beginPath(),
                            g.moveTo(v, u),
                            w && (k.beginPath(), k.moveTo(v, u)),
                            (A = { x: v, y: u })),
                        (b = f = !1))
                      : (g.lineTo(v, O),
                        w && k.lineTo(v, O),
                    ...
                    C < q.length - 1 &&
                      (N !== (q[C].lineColor || z) ||
                        U !== (q[C].lineDashType || t.lineDashType)) &&
                      (c(),
                      (N = q[C].lineColor || z),
                      (g.strokeStyle = N),
                      g.setLineDash &&
                        (q[C].lineDashType
                          ? ((U = q[C].lineDashType),
                            g.setLineDash(F(U, t.lineThickness)))
                          : ((U = t.lineDashType), g.setLineDash(Z)))),
                    (s = t.dataPointIds[C]),
                    (this._eventManager.objectMap[s] = {
                      id: s,
                      objectType: "dataPoint",
                    ...
                    0 !== q[C].markerSize &&
                      (0 < q[C].markerSize || 0 < t.markerSize) &&
                      ((O = t.getMarkerProperties(C, v, u, g)),
                      h.push(O),
                      (s = W(s)),
                      w &&
                        h.push({
                  ...
                  p < y.length - 1 &&
                    ...
                    c.setLineDash &&
                      (y[p].lineDashType
                        ...
                        : ((s = A.lineDashType), c.setLineDash(ba))));
            ...
            for (var Z = !0, p = 0; p < h.length; p++) {
              ...
              if (
                ...
                if ("number" !== typeof O.y)
                  ...
                  p < z.length - 1 &&
                    (N !== (z[p].lineColor || B) ||
                      v !== (z[p].lineDashType || A.lineDashType)) &&
                    (f(),
                    c.beginPath(),
                    c.moveTo(m, e),
                    n.push({ x: m, y: s - ma }),
                    ...
                    c.setLineDash &&
                      (z[p].lineDashType
                        ? ((v = z[p].lineDashType),
                          c.setLineDash(F(v, A.lineThickness)))
                        : ((v = A.lineDashType), c.setLineDash(ba))));
                  if (0 <= A.dataPointIndexes[t]) {
    ...
    u.prototype.renderCandlestick = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var q = 0; q < a.dataSeriesIndexes.length; q++) {
          ...
          if (0 < s.length)
            for (
              var G = 5 < t && v.bevelEnabled ? !0 : !1, l = 0;
              l < s.length;
              l++
            )
              if (
                ...
                "candlestick" === v.type
                  ? (b.moveTo(n - z, r),
                    ...
                    Y(
                      ...
                      D,
                      Math.max(h, m),
                      s[l].y[0] <= s[l].y[3] ? v.risingColor : g,
                      A,
                      d,
                      G,
                      G,
    ...
    u.prototype.renderBoxAndWhisker = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (
          var q = !1, q = !!a.axisY.reversed, u = 0;
          ...
          if (0 < G.length)
            for (
              var y = 5 < t && s.bevelEnabled ? !0 : !1, k = 0;
              k < G.length;
              k++
            )
              if (
                ...
                var D = (l - t / 2) << 0,
                  ...
                  U =
                    "number" === typeof G[k].whiskerThickness
                      ...
                      ? s.whiskerThickness
                      : z,
                  ba = G[k].whiskerDashType
                    ? G[k].whiskerDashType
                    : s.whiskerDashType,
                  Z = x(G[k].whiskerLength)
                    ? x(s.options.whiskerLength)
                      ? t
                      : s.whiskerLength
                    : G[k].whiskerLength,
                  Z =
    ...
    u.prototype.renderError = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var s = 0, v = 0; v < this.data.length; v++)
          !this.data[v].type.match(/(bar|column)/gi) ||
            !this.data[v].visible ||
            (this.data[v].type.match(/(stacked)/gi) && s) ||
            s++;
        for (var u = 0; u < a.dataSeriesIndexes.length; u++) {
          var G = a.dataSeriesIndexes[u],
            ...
            B = 0;
          if (A)
            for (d = y._linkedSeries.id, v = 0; v < d; v++)
              !this.data[v].type.match(/(bar|column)/gi) ||
                !this.data[v].visible ||
                (this.data[v].type.match(/(stacked)/gi) && B) ||
                (this.data[v].type.match(/(range)/gi) && (g = !0), B++);
          d = this.dataPointMinWidth
            ? this.dataPointMinWidth
            : this.dataPointWidth
            ? this.dataPointWidth
          ...
          if (0 < D.length)
            for (var F = y._colorSet, l = 0; l < D.length; l++) {
              var d = (y.lineColor = y.options.color ? y.options.color : F[0]),
                N = {
                  color: D[l].whiskerColor
                    ...
                    ? y.whiskerColor
                    : d,
                  thickness: x(D[l].whiskerThickness)
                    ? y.whiskerThickness
                    : D[l].whiskerThickness,
                  dashType: D[l].whiskerDashType
                    ? D[l].whiskerDashType
                    : y.whiskerDashType,
                  length: x(D[l].whiskerLength)
                    ? x(y.options.whiskerLength)
                      ? v
                      : y.options.whiskerLength
                    : D[l].whiskerLength,
                  trimLength: x(D[l].whiskerLength)
                    ? x(y.options.whiskerLength)
                      ? 50
                      : 0
                    : 0,
              ...
              N.length =
                "number" === typeof N.length
                  ? 0 >= N.length
                    ...
                    ? v
                    : N.length
                  : "string" === typeof N.length
                  ? (parseInt(N.length) * v) / 100 > v
                    ? v
                    : (parseInt(N.length) * v) / 100 > v
                  : v;
              N.thickness =
                "number" === typeof N.thickness
                  ? 0 > N.thickness
                    ? 0
                    : Math.round(N.thickness)
                  : 2;
              var U = {
                color: D[l].stemColor
                  ? D[l].stemColor
              ...
              U.thickness =
                "number" === typeof U.thickness
                  ? 0 > U.thickness
                    ? 0
                    : Math.round(U.thickness)
                  : 2;
              ...
              if (
                ...
                c
                  ? ((m = a.axisX.reversed
                      ? (h + ((A ? s : 1) * v) / 2 - (A ? B - 1 : 0) * v) << 0
                      : (h - ((A ? s : 1) * v) / 2 + (A ? B - 1 : 0) * v) << 0),
                    (e = a.axisX.reversed ? (m - v) << 0 : (m + v) << 0))
                  : ((r = a.axisX.reversed
                      ? (n + ((A ? s : 1) * v) / 2 - (A ? B - 1 : 0) * v) << 0
                      : (n - ((A ? s : 1) * v) / 2 + (A ? B - 1 : 0) * v) << 0),
        ...
        for (var l = 0; l < a.dataSeriesIndexes.length; l++) {
          ...
          if (0 < p.length) {
            ...
            for (var N = !0; e < p.length; e++)
              if (
                ((v = p[e].x.getTime ? p[e].x.getTime() : p[e].x),
                !(
                  v < a.axisX.dataInfo.viewPortMin ||
                  (v > a.axisX.dataInfo.viewPortMax &&
                    (!r.connectNullData || !N))
            ...
            for (
              ...
              if (
                ...
                0 < k &&
                  z &&
                  (!y || q.connectNullData) &&
                  (y && b.setLineDash && b.setLineDash(F(B, v)),
                  b.beginPath(),
                  b.moveTo(z, A - u),
                  b.lineTo(N, U - u),
                  0 < v && b.stroke(),
    ...
    u.prototype.renderPie = function (a) {
      function f() {
        if (h && r) {
          for (var a = 0, b = 0, c = 0, d = 0, f = 0; f < r.length; f++) {
            ...
            l.indexLabelLineThickness = x(g.indexLabelLineThickness)
            ...
            l.indexLabelFontSize = x(g.indexLabelFontSize)
      ...
      function b(a) {
        ...
        for (b = 0; b < r.length; b++) {
          ...
          if (d > c) {
            ...
            if (r[b].exploded) {
              if (
                1e-9 < Math.abs(e[b].center.x - (w.x + f)) ||
                1e-9 < Math.abs(e[b].center.y - (w.y + g))
              )
                (e[b].center.x = w.x + f * a),
                  (e[b].center.y = w.y + g * a),
                  (k = !0);
            } else if (
              0 < Math.abs(e[b].center.x - w.x) ||
              0 < Math.abs(e[b].center.y - w.y)
            )
      ...
      function g(a, b, f) {
        ...
        if (0 <= a && a < r.length) {
          ...
          k =
            "right" === l.hemisphere
              ? w.x + Math.sqrt(Math.pow(q, 2) - Math.pow(b - w.y, 2))
              : w.x - Math.sqrt(Math.pow(q, 2) - Math.pow(b - w.y, 2));
          ...
          h &&
            ...
            (b =
              "right" === l.hemisphere
                ? w.x + Math.sqrt(Math.pow(q, 2) - Math.pow(f - w.y, 2))
                : w.x - Math.sqrt(Math.pow(q, 2) - Math.pow(f - w.y, 2))),
            ...
            (l.indexLabelAngle = Math.atan2(
              l.indexLabelTextBlock.y - w.y,
              l.indexLabelTextBlock.x - w.x
            )));
        }
        return h;
      }
                ...
                if (0 > z) {
                  ...
                  "right" === l.hemisphere
                    ? ((F = g(a, x)),
                      (D = -1 * (z - F)),
                      (Ca = g(y, D)),
                      +Ca.toFixed(u) < +D.toFixed(u) &&
                        +F.toFixed(u) <= +x.toFixed(u) &&
                        g(a, -(D - Ca)))
                    : ((F = g(y, x)),
                      (D = -1 * (z - F)),
                      (Ca = g(a, D)),
              ...
              (y = y = 0),
                ...
                0 < y &&
                  (!k &&
                    ...
                    0.3 * l.indexLabelTextBlock.maxWidth > x
                      ? (l.indexLabelText = "")
                      : (l.indexLabelTextBlock.maxWidth = 0.85 * x),
                    0.3 * l.indexLabelTextBlock.maxWidth < x &&
                      (l.indexLabelTextBlock.x -=
                  ...
                  (!k &&
                    ...
                    ((x =
                      0 < l.indexLabelAngle && l.indexLabelAngle < Math.PI
                        ...
                        : 1),
                    0 === g(a, y * x) && g(a, 2 * x)),
                  Math.abs(l.indexLabelTextBlock.x - w.x) < A &&
              ...
              if (((g = !1), (v = e[k]), v.indexLabelText)) {
                ...
                if (null !== h) {
                  ...
                  if ((m = 0 > z)) {
                    ...
                    var n =
                        v.indexLabelTextBlock.y -
                        v.indexLabelTextBlock.height / 2,
                      t =
                        v.indexLabelTextBlock.y +
                        v.indexLabelTextBlock.height / 2,
                      q =
                      ...
                      u =
                        ...
                        l.indexLabelTextBlock.height / 2;
                    m =
                      v.indexLabelTextBlock.x + v.indexLabelTextBlock.width <
    ...
    u.prototype.renderFunnel = function (a) {
        ...
        for (
          ...
          (a = (Math.abs(u[k].y) * f) / g),
            n
              ...
              : ((sqrt = da * da * b * b - 4 * Math.abs(da) * a),
                0 > sqrt
                  ? ((m = c),
                    (h = ((b + m) * (e - l)) / 2),
                    (a -= h),
                    ...
                    (l += a / m),
                    (n = !0))
                  : ((h = (Math.abs(da) * b - Math.sqrt(sqrt)) / 2),
                    (m = b - (2 * h) / Math.abs(da)),
                    (l += h),
                    l > e &&
                      ((l -= h),
        ...
        if (v && u) {
          ...
          for (
            ...
            a = b.color
              ? b.color
              : v.reversed
              ? v._colorSet[(u.length - 1 - z) % v._colorSet.length]
              : v._colorSet[z % v._colorSet.length];
            ...
            m =
              "number" === typeof b.indexLabelLineThickness
                ...
                : "number" === typeof v.indexLabelLineThickness
            ...
            p =
              "undefined" !== typeof b.indexLabelWrap
                ? b.indexLabelWrap
                : "undefined" !== typeof v.indexLabelWrap
                ? v.indexLabelWrap
                : !0;
            r = v.dataPointIds[z];
            ...
            b = b.indexLabelFormatter
              ...
              : b.indexLabel
              ? s.replaceKeywordsWithValue(b.indexLabel, b, v, z)
              : v.indexLabelFormatter
              ? v.indexLabelFormatter(A)
              : v.indexLabel
              ? s.replaceKeywordsWithValue(v.indexLabel, b, v, z)
              : b.label
              ? b.label
              : "";
            0 >= m && (m = 0);
      ...
      function d() {
        ...
        for (
          var g = J - S - M / 2,
            g = v.options.indexLabelMaxWidth
              ? v.indexLabelMaxWidth > g
                ? g
            ...
            (a = L[h]),
              ...
              v.reversed
                ? (H[h].textBlock.y + H[h].height > T + z &&
                  ...
                  H[h].textBlock.y < X - z && (H[h].textBlock.y = X - z))
                : (H[h].textBlock.y < T - z && (H[h].textBlock.y = T - z),
                  H[h].textBlock.y + H[h].height > X + z &&
                    (H[h].textBlock.y = X + z - H[h].height));
      }
      function g() {
        var a, b, c, d;
              ...
              : ((a = L[f]),
                ...
                v.reversed
                  ? (H[f].textBlock.y + H[f].height > T + z &&
                    ...
                    H[f].textBlock.y < X - z && (H[f].textBlock.y = X - z))
                  : (H[f].textBlock.y < T - z && (H[f].textBlock.y = T - z),
                    H[f].textBlock.y + H[f].height > X + z &&
                      (H[f].textBlock.y = X + z - H[f].height)));
        else
          ...
          for (var k, l = 1; l < h; l++) {
            ...
            for (var r = H.length - 1; 0 <= r; r--)
              !H[r].isDirty &&
                ...
                ((k = m(r)),
                !(k >= H.length - 1) &&
                  H[r].textBlock.y + H[r].height + fa > H[k].textBlock.y &&
                  (H[r].textBlock.y =
          ...
          for (k = L.length - 1; 0 < k; k--)
            if (!H[k].isDirty) {
              ...
              if (H[k].textBlock.y < H[e].textBlock.y + H[e].height) {
                ...
                for (
                  h = 0;
                  H[f].textBlock.y < H[e].textBlock.y + H[e].height + fa;
      ...
      function l(a, b) {
        return (
          (b < L.length ? H[b].textBlock.y : v.reversed ? T + z : X + z) -
          (0 > a
            ? v.reversed
              ? X - z
              : T - z
      ...
      function n(a, b, c) {
        function d(b, c, f, h) {
          ...
          var l = {};
          l.dataSeries = v;
          l.dataPoint = v.reversed
            ? v.dataPoints[u.length - 1 - b]
            : v.dataPoints[b];
          ...
          1 == k
            ? ((ia = !1), h.cancelRequestAnimFrame.call(window, n))
        ...
        if (0 === aa.length) f = ja;
          ...
          l =
            (z *
              (1 != aa.length || (0 != aa[0] && aa[0] != L.length - 1)
                ? 2
                : 1)) /
            h();
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        for (
          var v = this.data[a.dataSeriesIndexes[0]],
            u = v.dataPoints,
            y = this.plotArea,
            z = 0.025 * y.width,
            D = 0.01 * y.width,
          ...
          if (
            (!A &&
              "undefined" !== typeof u[B].indexLabel &&
              null !== u[B].indexLabel &&
              0 < u[B].indexLabel.toString().length &&
              (A = !0),
            !A &&
              "undefined" !== typeof u[B].label &&
              null !== u[B].label &&
              0 < u[B].label.toString().length &&
              (A = !0),
            (!A && "function" === typeof v.indexLabelFormatter) ||
              "function" === typeof u[B].indexLabelFormatter)
          )
            A = !0;
        A =
          A ||
          ("undefined" !== typeof v.indexLabel &&
            null !== v.indexLabel &&
            0 < v.indexLabel.toString().length);
        ("inside" !== v.indexLabelPlacement && A) ||
          (D = (12.5 * y.width) / 100);
        var B = y.x1 + D,
          J = y.x2 - D,
          N = y.y1 + z,
        ...
        if (0 != v.length && v.dataPoints && v.visible && 0 !== u.length) {
          ...
          "funnel" === v.type
            ? ((O = v.neckHeight),
              ...
              I > D ? (I = D - 0.5) : 0 >= I && (I = !0))
            : "pyramid" === v.type &&
              ((I = O = !0), (v.reversed = v.reversed ? !1 : !0));
          ...
          var R = B + D / 2,
            ...
            ga = -da,
            B =
              "area" === (v.valueRepresents ? v.valueRepresents : "height")
                ? b()
                : f();
          if (-1 !== B) {
            if (v.reversed)
              for (ha.push(ca), I = B.length - 1; 0 < I; I--)
                (ca += B[I]), ha.push(ca);
            else for (I = 0; I < B.length; I++) (ca += B[I]), ha.push(ca);
            if (v.reversed)
              for (I = 0; I < B.length; I++)
                ha[I] < $
                  ? (D.push(Y), R.push(K), (ea = I))
                  : (D.push((ha[I] - T + da * W) / da),
            ...
            for (I = 0; I < B.length - 1; I++)
              (ca = v.reversed
                ? u[u.length - 1 - I].color
                  ? u[u.length - 1 - I].color
                  : v._colorSet[(u.length - 1 - I) % v._colorSet.length]
                : u[I].color
                ? u[I].color
                : v._colorSet[I % v._colorSet.length]),
                I === ea
                  ? L.push({
                      x1: D[I],
                      y1: ha[I],
            ...
            for (I = 0; I < L.length; I++)
              (B = L[I]), wa(Z, B, v.fillOpacity), ja.push(B.y1);
            q(Z);
            A &&
              v.visible &&
              (c(),
            ...
            s.animationEnabled && s.animatedRender
              ...
              : s.animationEnabled &&
                A &&
                (t(), "inside" !== v.indexLabelPlacement && r(Z));
            this.funnelPyramidClickHandler = function (a) {
              ...
              if (
                ...
                if ("funnel" === v.type || "pyramid" === v.type)
                  v.reversed
                    ? (u[u.length - 1 - a].exploded = u[u.length - 1 - a]
                        .exploded
                        ? !1
                        : !0)
                    : (u[a].exploded = u[a].exploded ? !1 : !0);
                n(s, b);
              }
            };
            return {
    ...
    S.prototype.render = function () {
      var a = this.dockInsidePlotArea ? this.chart.plotArea : this.chart,
        ...
        l = (this.markerMargin =
          ...
          !x(this.chart.options.legend.markerMargin)
            ...
            var e = (m.legendMarkerType = m.legendMarkerType
              ...
              s =
                ...
                ("line" !== m.type &&
                  ...
                  : 0,
              v = m.legendMarkerBorderColor
                ? m.legendMarkerBorderColor
                : m.markerBorderColor,
              u = m.legendMarkerBorderThickness
            ...
            for (var w = 0; w < m.dataPoints.length; w++) {
              var y = m.dataPoints[w],
                ...
                v = y.legendMarkerBorderColor
                  ...
                  ? y.markerBorderColor
                  : m.markerBorderColor,
                u = y.legendMarkerBorderThickness
      ...
      if (0 < n.length) {
        ...
        this.itemWidth = t;
        this.height =
          !1 === this.itemWrap ? h.length * this.lineHeight : this.height + w;
    ...
    B.prototype.createLabels = function () {
      ...
      var m = this.scaleBreaks ? this.scaleBreaks._appliedBreaks : [],
        e = m.length
          ? x(this.scaleBreaks.firstBreakIndex)
            ? 0
        ...
        for (
          ...
          a ||
            ((a = this.labelFormatter
              ...
              ? this.labels[p]
              : za(p, this.valueFormatString, this.chart._cultureInfo)),
            (a = new ka(this.ctx, {
              x: 0,
              y: 0,
              maxWidth: g,
      ...
      if (this.labelAutoFit || this.options.labelAutoFit)
        if (
                      ...
                      if (!x(this.options.labelMaxWidth))
                        ...
                        if (
                          ...
                          c - 2 * g > d &&
                            ...
                            c >= 2 * g && c < 2.2 * g
                              ? ((this.sessionVariables.labelMaxWidth = g),
                                x(this.options.labelFontSize) &&
                                  12 < t &&
                                  ((t = Math.floor((12 / 13) * t)),
                                  a.measureText()),
                                (this.sessionVariables.labelFontSize = x(
          ...
          if (
            ((g = x(this.options.labelMaxWidth)
              ? (0.3 * this.chart.width) >> 0
              : this.options.labelMaxWidth),
            (k =
              "undefined" === typeof this.options.labelWrap || this.labelWrap
            ...
            this.sessionVariables.labelMaxWidth = g;
            this.sessionVariables.labelMaxHeight = k;
            this.sessionVariables.labelAngle = x(
              this.sessionVariables.labelAngle
            )
              ? 0
              : this.sessionVariables.labelAngle;
      ...
      for (b = 0; b < this.stripLines.length; b++) {
        ...
        if ("outside" === g.labelPlacement) {
          ...
          (k =
            ...
            (s =
              x(g.options.labelWrap) || g.labelWrap
                ? "bottom" === this._position || "top" === this._position
                  ? (0.8 * this.chart.width) >> 0
                  : (0.8 * this.chart.height) >> 0
                : 1.5 * this.labelFontSize),
            x(g.labelBackgroundColor) &&
              (x(g.startValue) && 0 !== g.startValue
                ? (g.labelBackgroundColor = w ? "transparent" : null)
    ...
    B.setLayoutAndRender = function (a, f, b, c, d, g) {
        ...
        if (m[e] && m[e].scaleBreaks && m[e].scaleBreaks._appliedBreaks.length)
          for (
            ...
            t[q].endValue < m[e].viewportMinimum ||
              (x(m[e].scaleBreaks.firstBreakIndex) &&
      ...
      for (
        ...
        m[e] &&
          m[e].title &&
          (m[e]._titleTextBlock = new ka(m[e].ctx, {
            text: m[e].title,
            horizontalAlign: "center",
      ...
      if ("normal" === d) {
        for (
          ...
          k = Math.round(g.x1 + $ + K);
          n = Math.round(
            g.x2 - aa - Y > r.width - 10 ? r.width - 10 : g.x2 - aa - Y
          );
          if (a && 0 < a.length)
            for (u = [], e = X = 0; e < a.length; e++)
                ...
                f[e]._labels &&
                  ...
                  (v =
                    ...
                    (l.textBlock.height - l.textBlock.fontSize / 2) *
                      Math.sin((Math.PI / 180) * Math.abs(l.textBlock.angle)))),
                r.panEnabled
                  ? (L = r.sessionVariables.axisX2.height)
                  : (r.sessionVariables.axisX2.height = L),
                (l = Math.round(g.y1)),
          ...
          if (b && 0 < b.length)
            for (e = 0; e < b.length; e++)
              (b[e].lineCoordinates = {}),
                ...
                (n = Math.round(
                  g.x2 - L - S > r.width - 10 ? r.width - 10 : g.x2 - L - S
                )),
                b[e].labelAutoFit &&
                  !x(u) &&
                  (0 < !a.length &&
            ...
            for (e = 0; e < f.length; e++) {
              ...
              if (c && 0 < c.length)
                for (K = 0; K < c.length; K++)
                  c[K] &&
                    c[K].labelAutoFit &&
                    ((n = c[K].lineCoordinates.x2), (k = n - L));
              f[e].lineCoordinates = {
                x1: n + W,
                y1: l,
                x2: n + W,
      ...
      if (a && 0 < a.length)
        for (e = 0; e < a.length; e++)
          a[e].renderGrid(),
            w && (a[e].createMask(), a[e].renderBreaksBackground());
      if (f && 0 < f.length)
        for (e = 0; e < f.length; e++)
          f[e].renderGrid(),
            w && (f[e].createMask(), f[e].renderBreaksBackground());
      if (b && 0 < b.length)
        for (e = 0; e < b.length; e++)
          b[e].renderGrid(),
            w && (b[e].createMask(), b[e].renderBreaksBackground());
      if (c && 0 < c.length)
        for (e = 0; e < c.length; e++)
          c[e].renderGrid(),
            w && (c[e].createMask(), c[e].renderBreaksBackground());
      if (a && 0 < a.length)
    ...
    B.prototype.calculateBreaksSizeInValues = function () {
      for (
          ...
          b =
            ...
            a /
              (this.logarithmic
                ...
                : this.conversionParameters.maximum -
                  this.conversionParameters.minimum),
          c = this.scaleBreaks && !x(this.scaleBreaks.options.spacing),
          d,
          g = 0;
        g < f.length;
        g++
        ...
        (d = c || !x(f[g].options.spacing)),
          (f[g].spacing =
            P(f[g].spacing, a, 8, d ? 0.1 * a : 8, d ? 0 : 3) << 0),
    ...
    B.prototype.calculateAxisParameters = function () {
      if (this.logarithmic) this.calculateLogarithmicAxisParameters();
        ...
        if (
          x(this.options.viewportMaximum) &&
          !x(this.sessionVariables.newViewportMaximum) &&
          !isNaN(this.sessionVariables.newViewportMaximum)
        )
          this.viewportMaximum = this.sessionVariables.newViewportMaximum;
    ...
    fa.prototype.render = function (a, f) {
      ...
      r.lineWidth = h;
      r.save();
      this.labelFontSize = x(this.options.labelFontSize)
        ? this.parent.labelFontSize
        : this.labelFontSize;
      if ("left" === this.parent._position || "right" === this.parent._position)
        (this.labelMaxWidth = x(this.options.labelMaxWidth)
          ? this.parent.bounds.x2 - this.parent.bounds.x1
          : this.labelMaxWidth),
          (this.labelMaxHeight =
            x(this.options.labelWrap) || this.labelWrap
              ? 3 * this.chart.height
          ...
          if (
            ...
            if (
              ...
              l.text = this.labelFormatter
                ...
                : x(this.options.label)
                ? ea(v, this.valueFormatString, this.chart._cultureInfo)
                : this.label;
            } else
              (k =
                1 === r.lineWidth % 2
        ...
        if (
          ...
          !1 === g.highlightEnabled ||
            ...
            "rangeSplineArea" === c.type
              ...
              ? wa(f, d.funnelSection, 0.3, "white")
              : "candlestick" === c.type
              ? ((f.globalAlpha = 1),
